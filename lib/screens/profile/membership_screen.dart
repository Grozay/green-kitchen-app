...
class _MembershipScreenState extends State<MembershipScreen> {
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    gradient: LinearGradient(
                      colors: [currentTierColor.withValues(alpha: 0.1), currentTierColor.withValues(alpha: 0.05)],
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    _buildStatRow('Available Points', '${membershipData['availablePoints']?.toString() ?? '0'} pts'),
                    _buildStatRow('Total Points Earned', '${membershipData['totalPointsEarned']?.toString() ?? '0'} pts'),
                    _buildStatRow('Total Points Used', '${membershipData['totalPointsUsed']?.toString() ?? '0'} pts'),
                    _buildStatRow('Total Spent (6 months)', '${_formatCurrency(membershipData['totalSpentLast6Months'])} VND'),
                    _buildStatRow('Member Since', _formatDate(membershipData['createdAt'])),
                    _buildStatRow('Tier Achieved', _formatDate(membershipData['tierAchievedAt'])),
                    _buildStatRow('Last Updated', _formatDate(membershipData['lastUpdatedAt'])),
                  ],
                ),
              ),
            ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    ..._buildCouponsList(customerCoupons.take(3).toList()), // Show first 3 coupons
                        ...
                        child: TextButton(
                          onPressed: () {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(content: Text('Full coupons list coming soon!')),
                            );
                          },
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  _buildBenefitItem('Earn points on every order', Icons.star_border),
                  _buildBenefitItem('Exclusive promotions and discounts', Icons.local_offer),
                  _buildBenefitItem('Priority customer support', Icons.support_agent),
                  _buildBenefitItem('Free delivery on orders over 50,000 VND', Icons.local_shipping),
                  _buildBenefitItem('Birthday special offers', Icons.cake),
                  _buildBenefitItem('Early access to new menu items', Icons.restaurant),
                  _buildBenefitItem('Personalized meal recommendations', Icons.recommend),
                ],
              ),
            ),
          ),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          membershipData['availablePoints']?.toString() ?? '0',
                          style: TextStyle(
                            fontSize: 18,
                            fontWeight: FontWeight.bold,
                    ...
                    LinearProgressIndicator(
                      value: _calculateProgress(membershipData['availablePoints'] ?? 0),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    ..._buildPointHistoryList(sortedPointHistories.take(_visibleHistoryCount).toList()),
  ...
  String _formatCurrency(dynamic amount) {
    ...
    final numValue = amount is num ? amount : num.tryParse(amount.toString()) ?? 0;
  ...
  double _calculateProgress(dynamic points) {
    final numPoints = points is num ? points : num.tryParse(points.toString()) ?? 0;
